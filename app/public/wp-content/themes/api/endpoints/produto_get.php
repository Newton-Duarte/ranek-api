...
function registra_api_produto_get() {
...
add_action('rest_api_init', 'registra_api_produto_get');
...
function registra_api_produtos_get() {
...
add_action('rest_api_init', 'registra_api_produtos_get');
